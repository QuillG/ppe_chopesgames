...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark" id="piedPage">
<div class='container-fluid'>
        	...
        	<div class="col-md-3 col-sm-6">
            	<h4>Nous suivre</h4>
                	<a href="https://www.facebook.com/ChopesGamesShop"><i class="bi bi-facebook"></i> Facebook</a>
                	<a href="https://www.twitter.com/ChopesGamesShop"><i class="bi bi-twitter"></i> Twitter</a>
